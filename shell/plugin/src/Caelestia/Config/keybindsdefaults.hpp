...
inline QJsonObject defaultKeybinds() {
    return QJsonObject{
        ...
        {"dashboard", ""},
        {"screenshot", ""},
        {"googleLens", "Meta+Shift+A"},
        {"screenRecording", "Meta+Ctrl+S"},
        {"lock", "Meta+L"},
        {"session", "Ctrl+Alt+Delete"},
        {"launcher", "Meta+Space; Meta"},
        {"launcherInterrupt", ""},
        {"sidebar", "Meta+B"},
        {"aiAssistant", ""},
        {"utilities", ""},
        ...
        {"windowSwitcherReverse", "Alt+Shift+Tab"},
        {"wallpaper", "Meta+Ctrl+T"},
        {"keybinds", "Meta+/"},
        {"foot", "Meta+Return"},
        {"firefox", "Meta+W"},
        {"code", "Meta+C"},
        {"github-desktop", "Meta+G"},
        {"nemo", "Meta+Alt+E"},
        {"kcolorpicker", "Meta+Shift+C"},
        {"krohnkiteFocusUp", ""},
        {"krohnkiteFocusDown", ""},
        {"krohnkiteFocusLeft", ""},
        {"krohnkiteFocusRight", ""},
        ...
        {"krohnkiteIncreaseMaster", ""},
        {"krohnkiteDecreaseMaster", ""},
