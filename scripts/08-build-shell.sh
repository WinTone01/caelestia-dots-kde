...
if [[ "${CAELESTIA_SETUP_RUNNING:-0}" == "0" ]]; then
    ...
    if command -v pacman >/dev/null; then
        ...
        sudo dnf install --needed qt6-qtwayland qt6-qtwayland-devel kf6-kglobalaccel-devel qt6-qtbase-private-devel -y || warn "qt6-qtwayland qt6-qtwayland-devel kf6-kglobalaccel-devel qt6-qtbase-private-devel install failed..."
    fi
